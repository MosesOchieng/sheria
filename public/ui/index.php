...
<br>
   <a href="new/index.html">  <svg viewBox="0 0 512 512" fill="currentColor">
 ...
 <div class="main-container">
  <div class="header">
   <div class="logo">Sheria Street
    <span class=logo-det>Sh</span></div>
   ...
   <div class="user-info">
    ...
    <div class="user-name">Faith Mutitu</div>
  ...
  <div class="user-box first-box">
   <div class="activity card" style="--delay: .2s">
    ...
    <div class="subtitle">Hello there welcome to Sheria Street.</div>
    <div class="activity-links">
     <div class="activity-link active">Daily reports.</div>
     <div class="activity-link notify">User request.</div>
    </div>
    <div class="destination">
     <div class="destination-card">
      <div class="destination-profile">
       <img class="profile-img" src="firm.png" alt="" />
      ...
      <div class="destination-points">
       <div class="point">Nairobi Insitute of women anfd Gender.</div>
       <div class="sub-point">Nairobi , Kasarani</div>
      </div>
     </div>
     <div class="destination-card">
      <div class="destination-profile">
       <img class="profile-img" src="m.png" alt="" />
       <div class="destination-length">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map-pin">
         <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" />
         <circle cx="12" cy="10" r="3" />
      ...
      <div class="destination-points">
       <div class="point">Kate and Kate  Law Firm</div>
       <div class="sub-point"> Dagoreti Nairobi Kenya ,CBD</div>
      </div>
     </div>
    </div>
   </div>
   <div class="discount card" style="--delay: .4s">
    ...
    <div class="discount-wrapper">
     <div class="discount-info">
      <div class="subtitle">Best monthly offer:</div>
      <div class="subtitle-count">$5</div>
      <div class="subtitle">Women in workplace growth.</div>
      <div class="subtitle-count dist">1 hour audio.</div>
     </div>
    ...
    <div class="discount-profile">
     ...
     <img class="discount-img" src="faith.jpeg" alt="">
     <div class="discount-detail">
      <div class="discount-name">Faith Mutitu</div>
      <div class="discount-type">Co-Founder Sheria Street</div>
     </div>
    </div>
    <div class="button offer-button">Buy to Listen</div>
   </div>
    ...
    <div class="cards card">
     <div class="cards-head">
      <div class="cards-info">
       <div class="calendar-hour">12.20 <span class="am-pm">pm</span></div>
       <div class="degree">
     ...
     <div class="items numbers">
      ...
      <div class="item is-active">26</div>
   ...
   <div class="account-wrapper" style="--delay: .8s">
    <div class="account-profile">
     <img src="faith.jpeg" alt="">
     <div class="blob-wrap">
      <div class="blob"></div>
      <div class="blob"></div>
      <div class="blob"></div>
     </div>
     <div class="account-name">Faith Mutitu</div>
     <div class="account-title">User</div>
       <a class="Button Yellow" href="#">Edit Profile</a>
    </div>
<div>
  <!-- partial:index.partial.html -->
  <svg display="none">
